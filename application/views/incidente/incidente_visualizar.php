...
<div class="container">
  <div class="card card-register mx-auto mt-5">
    ...
    <div class="card-header">Incidente <b style="color: red;"><?php echo $row->incidente_id; ?></b></div>
    <div class="card-body">
      ...
      <form method="post">
        <div class="form-group">
          <div class="form-row">
            <div class="col-md-6">
              ...
              <select class="form-control" id="incidente_categoria" disabled="">
            ...
            <div class="col-md-6">
              ...
              <select class="form-control" id="incidente_prioridade" disabled="">
        ...
        <div class="form-group">
          <div class="form-row">
            <div class="col-md-6">
              ...
              <select class="form-control" id="incidente_empresa" disabled="">
        ...
        <div class="form-group">
          ...
          <input class="form-control" id="incidente_titulo" type="text" aria-describedby="nameHelp" placeholder="Insira o título" value="<?php echo $row->incidente_titulo; ?>" disabled="">
        </div>
        <div class="form-group">
          <label for="incidente_descricao">Descrição</label>
          <textarea class="form-control" id="incidente_descricao" rows="5" placeholder="Insira a descrição" disabled=""><?php echo $row->incidente_descricao; ?></textarea>
        </div>
        <div class="form-group">
